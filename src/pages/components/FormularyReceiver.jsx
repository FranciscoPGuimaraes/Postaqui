...
function FormularyReceiver({ name, sender }) {
    ...
    // Redirect to packagePage with sender and receiver infos
    ...
    const goToPacote = () => {
        ...
        if (error.length > 0) {
            ...
            // Add sender and receiver infos in search params
        ...
        <div className='form'>
            ...
            <div className="flexBox">
                <div className="formInput">
                    <button className="submit" type="submit" onClick={goToPacote}>Avançar</button>
                </div>
            </div>
        </div>
    )
...
export default FormularyReceiver;
